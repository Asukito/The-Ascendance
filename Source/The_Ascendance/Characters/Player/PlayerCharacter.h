...
UCLASS()
class THE_ASCENDANCE_API APlayerCharacter : public ABaseCharacter
{
	GENERATED_BODY()
...
public:
	...
	void SetController(ATAPlayerController* controller);
...
protected:
	...
	UPROPERTY()
	TObjectPtr<ATAPlayerController> playerController;
